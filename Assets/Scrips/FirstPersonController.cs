...
public class FirstPersonController : MonoBehaviour
{
    ...
    [Header ("References")]
    [SerializeField] private CharacterController characterControloler;
    ...
    {
        if (characterControloler.isGrounded)
        {
    ...
    private void HandleMovement()
    {
        ...
        HandleJumping();
        characterControloler.Move(currentMovement * Time.deltaTime);
    }
